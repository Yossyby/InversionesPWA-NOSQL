            ...
            >
              ...
              <span
                style={{
                  ...
                  borderRadius: "999px",
                  border: "1px solid var(--color-border)",
                  background: article.sentiment === "positive" ? "rgba(46, 194, 126, 0.1)" : article.sentiment === "negative" ? "rgba(248, 81, 73, 0.1)" : "rgba(255, 255, 255, 0.05)",
                  color: article.sentiment === "positive" ? "var(--color-buy)" : article.sentiment === "negative" ? "var(--color-sell)" : "var(--color-text-muted)",
                  fontSize: "0.75rem",
                  fontWeight: 600
                }}
              >
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ margin: "0.5rem 0 0", fontSize: "1rem", fontWeight: 700, color: "var(--color-text)" }}>
            ...
            <div>
              ...
              <p style={{ margin: "0.5rem 0 0", fontSize: "1rem", fontWeight: 700, color: "var(--color-text)" }}>
                {(article.credibilityScore * 100).toFixed(0)}%
              </p>
            </div>
          </div>
        </div>
